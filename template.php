...
<head>
  ...
  <meta name="author" content="mohamad.arfakhsy13@gmail.com">
      ...
      <div class="col-5">
        <div class="row no-gutters">
          <div class="col-1 header-kotak">
            <div class="header-atas masihi" id="hari">20</div>
            <div class="header-atas hijrah" id="hari-islam">2</div>
          </div>
          <div class="col-5 header-kotak">
            <div class="header-atas masihi" id="bulan">OKTOBER</div>
            <div class="header-atas hijrah" id="bulan-islam">Jamadil Awal</div>
          </div>
          <div class="col-2 header-kotak">
            <div class="header-atas masihi" id="tahun">2016</div>
            <div class="header-atas hijrah" id="tahun-islam">1439</div>
          </div>
          <div class="col-4 header-kotak">
            <div class="header-atas hari-ini" id="day"></div>
